...
const ScribbleLine = ({
  ...
  return (
    <svg
      ...
      aria-hidden
    >
      <path d={d} fill="none" stroke="#a79d91" strokeWidth={0.9} />
    </svg>
  );
};
  ...
  if (variant === "image") {
    ...
    return (
      <div className="flex h-full w-full flex-col gap-1.5 overflow-hidden p-4">
        <div className="mb-2 h-1.5 w-1/4 rounded-[1px] bg-[#f1c46d]/40" />
  ...
  return (
    <div className="flex h-full w-full flex-col gap-1.5 overflow-hidden p-4">
      ...
      <div className="my-1.5 flex gap-2">
        <div className="h-3 w-[36%] rounded-[2px] border border-white/12" />
        <div className="h-3 w-[18%] rounded-[2px] border border-white/12" />
      </div>
      <div className="flex flex-col gap-1.5">
      ...
      <div className="my-1.5 flex gap-2">
        <div className="h-3 w-[28%] rounded-[2px] border border-white/12" />
        <div className="h-2.5 w-[24%] rounded-[1px] bg-white/12" />
      </div>
      <div className="flex flex-col gap-1.5">
...
const ResultBody = () => (
  <div className="flex flex-col gap-[3px] rounded-md border border-white/10 bg-[#14120f] p-2 shadow-[0_10px_24px_rgba(0,0,0,0.28)]">
    {Array.from({ length: 3 }).map((_, i) => (
      <div key={i} className="grid grid-cols-3 gap-[3px]">
        <div className="h-1.5 rounded-[1px] bg-[#f1c46d]/26" />
        <div className="col-span-2 h-1.5 rounded-[1px] bg-white/10" />
      </div>
    ))}
  </div>
);
  ...
  return (
    ...
    >
        ...
        >
          {documents.map((doc, i) => (
            <SlidingDoc
              ...
              paused={paused}
              className={cn(
                "rounded-[14px] border border-white/10 bg-[#15130f] shadow-[0_16px_50px_rgba(0,0,0,0.38)]",
                classNames?.document,
              )}
            />
          ))}
      ...
      <motion.div
        key={`center-${burstId}`}
        className={cn(
          "pointer-events-none absolute left-1/2 top-1/2 z-30 flex items-center justify-center rounded-[12px] border border-white/14 bg-[#f1c46d] p-2 text-[#11100d] shadow-[0_18px_70px_rgba(241,196,109,0.24)]",
          classNames?.center,
        )}
        style={{
          width: centerSize,
